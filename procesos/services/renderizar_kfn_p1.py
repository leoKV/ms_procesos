...
class RenderizaKFNP1(BaseProceso):
    ...
    def _search_kfn(self):
        try:
            ...
            msg = f"[ERROR] No se pudo descargar el archivo KFN: {str(e)})"
            logger.error(msg)
            print(msg)
    ...
    def _kfn_karaoke(self):
        try:
            ...
            msg = f"[ERROR] No se pudo renderizar el Karaoke: {str(e)})"
            logger.error(msg)
            print(msg)
    ...
    def _insertar_proceso_p2(self):
        try:
            ...
            msg = "[INFO] Proceso: Renderizar KFN Parte 2 - Insertado correctamente."
            logger.info(msg)
            print(msg)
        except Exception as e:
