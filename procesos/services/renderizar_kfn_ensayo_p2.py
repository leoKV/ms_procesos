...
class RenderizaKFNEnsayoP2(BaseProceso):
    ...
    def _karaoke_final(self, path_caratula_mp4):
        try:
            ...
            msg = _log_print("INFO","Creando Karaoke Ensayo...")
            logger.info(msg)
            ...
            if os.path.exists(path_karaoke_final):
                msg = _log_print("INFO","Karaoke Ensayo creado correctamente.")
                logger.info(msg)
                #Drive Ensayo
            ...
            msg = _log_print("ERROR",F"Error al crear Karaoke Ensayo: {e}")
            logger.error(msg)
        except Exception as e:
            msg = _log_print("ERROR",f"Fallo inesperado al crear Karaoke Ensayo: {e}")
            logger.error(msg)
